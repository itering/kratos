...
import (
	...
	"github.com/itering/kratos/pkg/net/rpc/warden/resolver"
	"github.com/itering/kratos/pkg/net/rpc/warden/resolver/direct"

	"github.com/itering/kratos/pkg/conf/env"
	"github.com/itering/kratos/pkg/conf/flagvar"
	"github.com/itering/kratos/pkg/ecode"
	"github.com/itering/kratos/pkg/naming"
	nmd "github.com/itering/kratos/pkg/net/metadata"
	"github.com/itering/kratos/pkg/net/netutil/breaker"
	"github.com/itering/kratos/pkg/net/rpc/warden/balancer/p2c"
